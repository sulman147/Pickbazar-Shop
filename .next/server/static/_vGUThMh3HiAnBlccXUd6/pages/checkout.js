...
const PaymentCard = ({
  ...
  }, PaymentCard_jsx(AllSvgIcon["o" /* CloseIcon */], null)));
};
...
const PaymentGroup = ({
  ...
  return PaymentGroup_jsx(external_react_default.a.Fragment, null, PaymentGroup_jsx(Header, null, items.length !== 0 && PaymentGroup_jsx(SavedCard, null, PaymentGroup_jsx(external_react_intl_["FormattedMessage"], {
    ...
    variant: "textButton",
    type: "button",
    icon: PaymentGroup_jsx(AllSvgIcon["W" /* Plus */], null),
    iconPosition: "left",
...
const UpdateAddress = props => {
  ...
  return UpdateAddress_jsx(external_formik_["Form"], null, UpdateAddress_jsx(Update_style["b" /* Heading */], null, item && item.id ? 'Edit Address' : 'Add New Address'), UpdateAddress_jsx(Update_style["a" /* FieldWrapper */], null, UpdateAddress_jsx(TextField_TextField, {
    id: "name",
    type: "text",
...
/* harmony default export */ var Update_UpdateAddress = __webpack_exports__["a"] = (FormEnhancer(UpdateAddress));
...
RadioCard.defaultProps = {
  title: '',
  content: '',
  editIcon: __jsx(_AllSvgIcon__WEBPACK_IMPORTED_MODULE_3__[/* PencilIcon */ "U"], null),
  deleteIcon: __jsx(_AllSvgIcon__WEBPACK_IMPORTED_MODULE_3__[/* CloseIcon */ "o"], null),
...
const CheckcoutWrapper = external_styled_components_default.a.div.withConfig({
  displayName: "Checkoutstyle__CheckcoutWrapper",
  componentId: "sc-1upngdh-0"
...
/* harmony default export */ var Checkout_style = (CheckcoutWrapper);
...
const Checkout = ({
  ...
  } = Object(external_react_["useState"])(Object(utility["f" /* getDiscount */])());
  const {
    0: processedCoupon,
    1: setProcessedCoupon
  } = Object(external_react_["useState"])(Object(utility["e" /* getCoupon */])());
  const {
    state,
    dispatch
  } = Object(external_react_["useContext"])(profile_context["a" /* ProfileContext */]);
  ...
  const items = Object(utility["d" /* getCartProducts */])();
  const subTotalPrice = Object(utility["h" /* getSubTotalPrice */])();
  const totalPrice = Object(utility["i" /* getTotalPrice */])();
  ...
  const handleSubmit = async () => {
    ...
    if (isValid) {
      clearCart();
      router_default.a.push('/order-recived');
    }
  ...
  }), " (", items.length, ' ', __jsx(external_react_intl_["FormattedMessage"], {
    id: "itemsText",
  ...
  })), processedDiscount && processedCoupon.code !== 'DEFAULT_COUPON' ? __jsx(CouponBox["a" /* CouponDisplay */], {
  ...
  })), __jsx(OrderAmount, null, "$", totalPrice))), __jsx(DeliverySchedule, null, __jsx(Heading, null, __jsx(external_react_intl_["FormattedMessage"], {
    id: "deliverySchedule",
...
const CheckoutPage = ({
  ...
  const token = true;
  return checkout_jsx(external_react_default.a.Fragment, null, checkout_jsx(head_default.a, null, checkout_jsx("title", null, "Checkout - PickBazar")), checkout_jsx(profile_provider["a" /* ProfileProvider */], {
    initData: data.me
  }, checkout_jsx(reuse_modal_["Modal"], null, checkout_jsx(Checkout_Checkout, {
    token: token,
    deviceType: deviceType
  }))));
};
  ...
  switch (action.type) {
    ...
    case 'ADD_OR_UPDATE_CONTACT':
      if (action.payload.id) {
        return _objectSpread({}, state, {
          contact: state.contact.map(item => item.id === action.payload.id ? _objectSpread({}, item, {}, action.payload) : item)
        });
      }

      const newContact = _objectSpread({}, action.payload, {
        id: v4_default()(),
    ...
    case 'ADD_OR_UPDATE_ADDRESS':
      if (action.payload.id) {
        return _objectSpread({}, state, {
          address: state.address.map(item => item.id === action.payload.id ? _objectSpread({}, item, {}, action.payload) : item)
        });
      }
    ...
    case 'SET_PRIMARY_CONTACT':
      return _objectSpread({}, state, {
        contact: state.contact.map(item => item.id === action.payload ? _objectSpread({}, item, {
          type: 'primary'
        }) : _objectSpread({}, item, {
          type: 'secondary'
        }))
    ...
    case 'SET_PRIMARY_ADDRESS':
      return _objectSpread({}, state, {
        address: state.address.map(item => item.id === action.payload ? _objectSpread({}, item, {
          type: 'primary'
        }) : _objectSpread({}, item, {
          type: 'secondary'
        }))
    ...
    case 'SET_PRIMARY_SCHEDULE':
      return _objectSpread({}, state, {
        schedules: state.schedules.map(item => item.id === action.payload ? _objectSpread({}, item, {
          type: 'primary'
        }) : _objectSpread({}, item, {
          type: 'secondary'
        }))
    ...
    case 'SET_PRIMARY_CARD':
      return _objectSpread({}, state, {
        card: state.card.map(item => item.id === action.payload ? _objectSpread({}, item, {
          type: 'primary'
        }) : _objectSpread({}, item, {
          type: 'secondary'
        }))
